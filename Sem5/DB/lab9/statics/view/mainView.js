import render_info from "./infoView.js"
import render_add from "./addView.js";
import { show_docs, show_docs_w } from "../model/util/dataUtil.js"
...
export function render_main() {
    ...
    let options = ["Курчатов Павел Владиславович", "Образин Антон Степанович", "Нефитов Григорий Александрович", "Кимурин Евгений Олегович", "Пелевин Антон Дмитриевич"];
