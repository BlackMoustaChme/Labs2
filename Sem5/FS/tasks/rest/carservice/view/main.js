...
function renderAllProducts(){
    sendRequest("post", "api/product/", null, function(){
...
function renderUserProducts() {
    ...
    sendRequest("post", "api/product/userProduct", jsonLogin, function () {
        if (this.readyState != 4 | this.status != 200) {
            return;
        }
        if (this.responseText == "No access") {
...
function sendDeleteInfo(){
    ...
    sendRequest("post", "api/product/delete", jsonProductsID, function(){
        if (this.readyState != 4 | this.status != 200) {
            return;
        }
        if (this.responseText == "No access") {
...
function sendSaleInfo(){
    ...
    if (check_valid(jsonSale)){
        ...
        sendRequest("post", "api/product/sale", jsonSale, function(){
            if (this.readyState != 4 | this.status != 200) {
                return;
            }
            if (this.responseText == "No access") {
